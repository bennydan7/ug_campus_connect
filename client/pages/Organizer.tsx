          ...
          <aside className="md:col-span-1">
            <div className="rounded-xl bg-white p-4 shadow">
              <div className="flex items-center gap-3">
                <div className="h-12 w-12 rounded-lg bg-primary text-primary-foreground grid place-items-center font-bold">
                  OG
                </div>
                <div>
              ...
              <div className="mt-6 space-y-2">
                <button
                  ...
                  className={`flex w-full items-center gap-3 rounded-md px-3 py-2 text-sm ${selectedTab === "My Events" ? "bg-primary/10" : ""}`}
                >
                  <Calendar className="h-4 w-4" /> My Events
                </button>
                <button
                  onClick={() => setSelectedTab("Create Event")}
                  className={`flex w-full items-center gap-3 rounded-md px-3 py-2 text-sm ${selectedTab === "Create Event" ? "bg-primary/10" : ""}`}
                >
                  <PlusCircle className="h-4 w-4" /> Create Event
                </button>
                <button
                  onClick={() => setSelectedTab("Analytics")}
                  className={`flex w-full items-center gap-3 rounded-md px-3 py-2 text-sm ${selectedTab === "Analytics" ? "bg-primary/10" : ""}`}
                >
              ...
              <div className="mt-6 border-t pt-4">
                {!isLoggedIn ? (
                  ...
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-md bg-muted px-3 py-2 text-sm font-semibold"
                  >
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="rounded-md bg-secondary/10 px-3 py-1 text-sm font-semibold"
                          >
                            Edit
                          </button>
                          <button
                            onClick={() => handleDelete(e.id!)}
                            className="rounded-md bg-destructive/80 px-3 py-1 text-sm font-semibold text-destructive-foreground"
                          >
                            Delete
                          </button>
                        </div>
                ...
                <div>
                  {!isLoggedIn ? (
                    ...
                    <form
                      ...
                      onSubmit={(e) => {
                        e.preventDefault();
                        editingId ? handleUpdate() : handlePost();
                      }}
                    >
                      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                        ...
                        <input
                          ...
                          value={form.dateISO}
                          onChange={(e) =>
                            setForm((s) => ({ ...s, dateISO: e.target.value }))
                          }
                          className="rounded-md border px-3 py-2"
                        />
                      </div>
